//
//  lib/widgets/about_item_widget.dart
//
...
class AboutItemWidget extends StatelessWidget with Scale {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        CircleIconWidget(iconName, iconSize: iconSize, radius: 22.5, scale: scale),
